// Taken from:
// https://github.com/openscad/MCAD/pull/25
// https://github.com/openscad/MCAD/blob/8f0a9853d07c869d50112f47933750041d2b7deb/strings.scad
...
function index_of(string, pattern, index=0, pos=0, ignore_case=false, regex=false) = 
	...
	: len(pattern) == 1 && !ignore_case?
		search(pattern, after(string, pos-1), 0)[0][index] + pos
	: index <= 0?
